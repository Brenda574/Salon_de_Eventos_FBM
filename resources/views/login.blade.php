                ...
                <div class="col-xl-10">
                    <div class="card rounded-3 text-black" style="background-color: #b5c1b7;">
                        <div class="row g-0">
                                ...
                                <div class="card-body p-md-5 mx-md-4">
                                    ...
                                    <form style="padding-top: 2rem">
                                        <div class="form-outline mb-4">
                                            <input type="email" id="form2Example11" class="form-control" placeholder="Correo electronico" />
                                        ...
                                        <div class="text-center pt-1 mb-5 pb-1">
                                            <div><button class="btn boton4 custom-2 mb-3" type="button" style="background-color: #E1D5D5; transition: all 0.35s;">Iniciar sesión</button></div>
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2 ard rounded-3" style="background-image: url('https://i.pinimg.com/564x/d6/9c/09/d69c096f70ab897a5318d1788809d967.jpg');background-size : 550px  750px; background-repeat : no-repeat">
                            </div>
                        </div>
                    </div>
                </div>
