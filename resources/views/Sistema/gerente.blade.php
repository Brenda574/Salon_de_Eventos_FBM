                         ...
                         <table class="table table-hover">
                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td>150 a 200</td>
                                     <td>$10,000</td>
                                     <td>Paquete para eventos especiales como cumpleaños, bautizos, eventos familiares,
                                         entre otros. Con servicios incluidos.</td>
                                     <td>
                                         <a href="{{ route('paquete.show') }}" class="text-decoration-none texto-color"
                                             title="Detalles"><i class="bi bi-card-heading"></i></a>
                                         <a href="{{ route('paquete.edit') }}" class="text-decoration-none texto-color"
                                 ...
                                 <tr>
                                     ...
                                     <td>150 a 250</td>
                                     <td>$10,200</td>
                                     <td>Paquete para graducaiones de cualquier nivel educativo, con servicios incluidos.
                                     </td>
                                     <td>
                                         <a href="{{ route('paquete.show') }}" class="text-decoration-none texto-color"
                                             title="Detalles"><i class="bi bi-card-heading"></i></a>
                         ...
                         <table class="table table-hover">
                             ...
                             <tbody>
                                 <tr>
                                     ...
                                     <td>
                                         <a href="{{ route('servicio.show') }}" class="text-decoration-none texto-color"
                                             title="Detalles"><i class="bi bi-card-heading"></i></a>
                                         <a href="{{ route('servicio.edit') }}" class="text-decoration-none texto-color"
                                             title="Editar"><i class="bi bi-pencil-square"></i></a>
                                         <a href="" class="text-decoration-none texto-color" title="Eliminar"><i
                                                 class="bi bi-trash3-fill"></i></a>
                                     </td>
