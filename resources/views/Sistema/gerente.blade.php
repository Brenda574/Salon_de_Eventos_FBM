                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('usuario.destroy', $item)}}" method="post">
                                                @method('DELETE')
                                                @csrf
                                                <a href="{{ route('usuario.show', $item) }}" class="btn text-decoration-none texto-color" title="Detalles"><i class="bi bi-card-heading"></i></a>
                                                <a href="{{ route('usuario.edit', $item) }}" class="btn text-decoration-none texto-color" title="Editar"><i class="bi bi-pencil-square"></i></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route('paquete.destroy', $item)}}" method="post">
                                            @method('DELETE')
                                            @csrf
                                            <a href="{{ route('paquete.show', $item) }}" class="btn text-decoration-none texto-color" title="Detalles"><i class="bi bi-card-heading"></i></a>
                                            <a href="{{ route('paquete.edit', $item) }}" class="btn text-decoration-none texto-color" title="Editar"><i class="bi bi-pencil-square"></i></a>
                                            <button type="submit" class="btn btn-link text-decoration-none texto-color" title="Eliminar">
                                                <i class="bi bi-trash3-fill"></i>
                                            </button>
                                        </form>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{route('servicio.destroy', $item)}}" method="post">
                                            @method('DELETE')
                                            @csrf
                                            <a href="{{ route('servicio.show', $item) }}" class="btn text-decoration-none texto-color" title="Detalles"><i class="bi bi-card-heading"></i></a>
                                            <a href="{{ route('servicio.edit', $item) }}" class="btn text-decoration-none texto-color" title="Editar"><i class="bi bi-pencil-square"></i></a>
                                            <button type="submit" class="btn btn-link text-decoration-none texto-color" title="Eliminar">
                                                <i class="bi bi-trash3-fill"></i>
                                            </button>
                                        </form>
