                ...
                <div class="card h-100">
                    <div class="sc-hdr">
                        ...
                        <div class="capacidad-label">
                            <div class="cl-flex w-clearfix">
                                ...
                                <div class="cl-txt">{{$item['capacidad']}}</div>
                    ...
                    <div class="card-body" style="background-color: #fff9f9">
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            <div id="carouselExampleDar{{$item['id']}}" class="carousel carousel-dark slide" style="width: 60vh; text-align: center">
                                ...
                                <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleDar{{$item['id']}}"
                                    data-bs-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Previous</span>
                                </button>
                                <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleDar{{$item['id']}}"
                                    data-bs-slide="next">
