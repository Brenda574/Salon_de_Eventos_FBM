                    ...
                    @if ($evento->estatus == 'Pendiente')
                        <form action="{{ route('evento.update.autorizar', $evento->id) }}" method="post" id="evento">
                            ...
                            <p class="label fw-bold text-center">
                                ...
                                <input type="hidden" name="gerente" id="gerente" value="{{ Auth::user()->id }}">
            ...
            <div>
                <div class="row container_galery">
                        ...
                        <div class="row justify-content-center">
                            ...
                            @can('addGasto', $evento)
                                <div class="col-2 text-center">
                                    <br>
                                    <form action="{{ route('eliminar_gasto', $gasto->id) }}"
                                        method="post"class="eliminar_imagen-form">
                                        @csrf
                                        <a class="btn text-decoration-none texto-color" data-bs-toggle="collapse"
                                            href="#collapseEditGasto{{ $gasto->id }}" role="button"
                                ...
                                <div class="collapse col-4" id="collapseEditGasto{{ $gasto->id }}">
                                    <form action="{{ route('editar_gasto', $gasto->id) }}" method="post">
                                        ...
                                        <div class="card card-body">
                                            <small>CANTIDAD</small>
                                            <input type="number" class="form-control" value="{{ $gasto->monto }}"
                                                name="cantidadGasto" id="cantidadGasto">

                                            <small>CONCEPTO</small>
                                            <input type="text" class="form-control" value="{{ $gasto->descripcion }}"
                                                name="conceptoGasto" id="conceptoGasto">
                                        </div>
                                        <div class="d-grid gap-2 col-2 mx-auto">
                                            <button type="submit" class="btn emp_button"
                                                style="margin-top: 15px;">Aceptar</button>
                                        </div>
                                        <hr>
                                    </form>
                                </div>
                    ...
                    @if ($auxGasto > 0)
                        <div class="text-center">
                            <hr>
                            <p class="fw-bold" style="color: rgb(151, 6, 6)">Total de gatos: ${{ $auxGasto }}</p>
                        </div>
                    @endif
                    @can('addGasto', $evento)
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <form action="{{ route('subir_abono', ['idEvento' => $evento->id]) }}" method="post"
                            ...
                            <div class="mb-3">
                                ...
                                @if ($errors->first('costo'))
                                    <div class="text-danger text-opacity-75">Solo se aceptan montos</div>
                                @else
                                @endif
                            </div>
                        ...
                        <form action="{{ route('subir_gasto', ['idEvento' => $evento->id]) }}" method="post"
                            ...
                            <div class="mb-3">
                                ...
                                @if ($errors->first('monto'))
                                    <div class="text-danger text-opacity-75">Solo se aceptan gastos</div>
                                @else
                                @endif
                            </div>
                            <div class="mb-3">
                                ...
                                @if ($errors->first('descripcion'))
                                    <div class="text-danger text-opacity-75">Es importante colocar el concepto</div>
                                @else
                                @endif
                            </div>
                            <div class="d-grid gap-2 col-6 mx-auto">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('subir_imagen', ['idEvento' => $evento->id]) }}" method="post"
                        ...
                        @csrf
                        <div class="mb-3">
                            <input class="form-control" accept="image/*" type="file" name="archivo" id="archivo"
                                disabled>
                        </div>
                        <div>
